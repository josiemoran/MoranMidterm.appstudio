...
const cacheName = 'MoranMidterm-2021-03-15 16:45:13.046882'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'MoranMidterm'.length) === 'MoranMidterm') {
